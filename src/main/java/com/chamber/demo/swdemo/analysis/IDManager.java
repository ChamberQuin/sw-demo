...
package com.chamber.demo.swdemo.analysis;
...
//            }
//            return new InstanceIDDefinition(
//                strings[0],
//                decode(strings[1])
//            );
//        }
...
//    }
    ...
    public static void main(String[] args) {
        ...
        String representServiceId = "motan_server_0917";
        System.out.println(encode(representServiceId));

//        String id = "c3RhdGljLmNvbmZpZy5hcGkud2VpYm8uY29tOi0x="; // motan_server_yuanbo3
//        String id = "c3RhdGljLmNvbmZpZy5hcGkud2VpYm8uY29tOi0x"; // static.config.api.weibo.com:-1
//        String id = "Y29uZmlnLmFwaS53ZWliby5jb206LTE="; // config.api.weibo.com:-1
//        String id = "MTAuNzcuMTE0LjU0OjUwMjA1"; // 10.77.114.54:50205 redis
//        String id = "Y2FjaGUuc2VydmljZS5jb21tb25zLnBvb2wueWY="; // 10.77.114.54:50205 redis
//        String id = "bWVkaWFsaWJfMDkxNl9kZW1v"; // medialib_0916_demo
//        String id = "dmlkZW91bmlvbl8wOTE2X2RlbW8="; // videounion_0916_demo
//        String id = "aS5jb25mLnNzby5zaW5hLmNvbS5jbjotMQ=="; // i.conf.sso.sina.com.cn:-1
//        String id = "MTAuNzUuMTQuNTc6MTAxMDE="; // 10.75.14.57:10101 service_instance_id: MTAuNzUuMTQuNTc6MTAxMDE=.0_MTAuNzUuMTQuNTc6MTAxMDE=
        String id = "MTAuNzUuMTEuMTUwOjEwMTAy"; // 10.75.11.150:10102
//        String id = "bW90YW5fc2VydmVyX3l1YW5ibzM="; // motan_server_yuanbo3
//        String id = "bW90YW5fc2VydmVyXzA5MTc="; // motan_server_0917
        // network_address_alias:
        //  MTAuNzUuMTQuNTc6MTAxMDE=
        //  10.75.14.57:10101
        //  bW90YW5fc2VydmVyX3l1YW5ibzM=.0
        //  bW90YW5fc2VydmVyX3l1YW5ibzM=.0_bW90YW5fc2VydmVyX3l1YW5ibzM=
        //  0
        //  202109170949
